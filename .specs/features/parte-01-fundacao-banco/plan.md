...
| 4. esquema inicial | `CLIENTE(ID INTEGER PK, NOME VARCHAR(80), CEP CHAR(8), CPF_CNPJ VARCHAR(14), ENDERECO VARCHAR(100), NUMERO VARCHAR(20), COMPLEMENTO VARCHAR(60), BAIRRO VARCHAR(100), CIDADE INTEGER FK, DATANASCIMENTO DATE)`; `ESTADO(ID INTEGER PK, NOME VARCHAR(50), UF CHAR(2))`; `CIDADE(ID INTEGER PK, NOME VARCHAR(50), ESTADOID INTEGER FK)` | alterar nomes ou larguras diverge da especificação fornecida |
